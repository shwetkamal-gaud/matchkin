    ...
    const steps = [
            ...
            content: (
                <div className='flex flex-col gap-5'>
                    ...
                    {formData.accountType === 'Individual Consultant' ?
                        <>
                            <div>
                                <label htmlFor="fullName" className="block mb-2 flex items-center gap-1  text-sm font-medium text-gray-900 dark:text-white"><User className='dark:text-white text-[#ff691f] w-5 h-5' />  Full Name</label>
        ...
        },
        {
            ...
            content: <div className='flex flex-col gap-5'>
                ...
                <div>
                    <label htmlFor="job" className="block mb-2 flex items-center gap-1 text-sm font-medium text-gray-900 dark:text-white"><Briefcase className='dark:text-white text-[#ff691f] w-5 h-5' />  Your Job Title / Headline</label>
